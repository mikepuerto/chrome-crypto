...
(function() {
    ...
    var TradingView = {
        ...
        isPersentHeight: function(height) {
            return /%$/.test(height)
        },
        ...
        calculateWidgetHeight: function(widgetHeight, container_id) {
            ...
            var isPersentHeight = this.isPersentHeight(widgetHeight);
            var suffix = isPersentHeight ? "%" : "px";
            ...
            if (hasCopyright) {
                return newWidgetHeight - 32 + suffix
            }
